...
describe("ModerationView", () => {
  ...
  it("confirms before treating with DESACTIVATION, then PATCHes { statut: TRAITE, actionAdmin: DESACTIVATION }", async () => {
    const user = userEvent.setup();
  ...
  it("treats with AUCUNE without asking for confirmation", async () => {
    const user = userEvent.setup();
